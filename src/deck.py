...
class DeckEncoderDecoder:
    ...
    def _serialize_section(self, section: dict) -> str:
        ...
        return self._DELIMITER2.join(
            f"{key}{self._DELIMITER1}{value}" for key, value in section.items()
        )
    ...
    def _deserialize_section(self, section: str) -> dict:
        ...
        return {
            key: int(value)
            for key, value in (
                item.split(self._DELIMITER1) for item in section.split(self._DELIMITER2)
            )
        }
...
if __name__ == "__main__":
    deck1 = {
        "normal": {
            ...
            "Call of Khrulhu": 3,
            "Gambit_Death_02": 9,
            "GhostTouchRed_Trainable": 1,
            "Mega Pacify": 1,
            "Minion Death Seraph": 3,
            "Poison": 3,
            "Ramp_Death_02": 1,
            "Skeletal Pirate - T02 - A": 6,
            "Vampire": 1,
            "Catalan": 2,
            "Tri Blade": 1,
            "Tri Trap": 1,
        ...
        "tc": {
            ...
            "Frozen Armor TC": 1,
            "Legion Shield TC": 1,
            "Snow Serpent - T02 - B - TC": 1,
            "Steal Ward TC": 2,
            "Centaur TC": 1,
            "Forest Lord TC": 1,
            "Giant Spider TC KR": 2,
            "Rebirth TC": 1,
            "Regenerate TC": 2,
            "Sanctuary TC": 3,
            "Satyr TC": 2,
            ...
            "Spinysaur TC": 6,
            "Spirit Armor TC": 3,
            "Sprite Swarm TC KR": 1,
            "Unicorn TC": 2,
            "Heck Hound TC": 3,
            "Steal Charm TC": 1,
            "Wild Bolt TC": 2,
        },
        "item": {"Moon Shield": 1, "Wand-Death-145": 4, "Shadow Trap - Amulet": 2},
    }
